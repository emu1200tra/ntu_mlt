...
def adaboost(data , datax , datay , T):
  ...
  U_record.append(sum(U)) 
  return alpha , s , feature , theta , parameter , U_record
...
alpha , s , feature , theta , parameter , U_record = adaboost(data , datax , datay , T)
plt.plot(U_record)
plt.show()
print "U2:" , U_record[1] , 'UT:' , U_record[-1]